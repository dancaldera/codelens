...
import { createOpenAIClient, validateOpenAIConfiguration } from './client'
...
/**
 * Service for handling OpenAI API communication and response processing
 */
export class OpenAIService {
	private readonly options: Required<OpenAIServiceOptions>
	...
	/**
	 * Analyze code from images using OpenAI Vision API
	 */
...
- Always include FULL working code, not pseudocode or partial solutions
	...
	/**
	 * Parse OpenAI response and extract structured analysis
	 */
